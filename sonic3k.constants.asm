...
Pointer_Y			ds.w 1				; unused
Emerald_flicker_flag		ds.w 1			; controls the emerald flicker in save screen and special stage results.
Speedrun_Options_Choice			ds.b $1			; unused
Music_Toggle 			 ds.b $1
TB_Toggle 			 ds.b $1 ; time bonus toggle	
HUD_Toggle 			 ds.b $1 ; HUD toggle
FA_Toggle 			 ds.b $1 ; frame advance toggle
LR_Toggle 			 ds.b $1 ; level restart toggle
CustomRAM     ds.l $1 ; custom RAM address
Pointer_X 		ds.w $1	
DigitPointer ds.b $1
CustomBind ds.b $1
CustomBindCountdown ds.w $1
			ds.b $34			; unused
...
Menu_Page			ds.b 1				; 0 = Main menu, 1 = level select, 2 = options; 3 = exit
